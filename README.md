**Model overview:** [All applied models, experiments and performance scores](docs/ALL_MODEL_PERFORMANCE.md), grouped by evaluation protocol.

**Accuracy Improvement Stage E complete:** matched calibration500 predictions/evaluation and model-specific operating thresholds are frozen. E1/E3 AP50:95 **0.482829/0.429070**; thresholds **0.34/0.43**. E3 uniquely recovers **467** calibration GT objects at the selected thresholds; this is complementarity evidence, not a fusion result. Reserved1500 remains unopened by this workflow. The future E1/E3/E4 family gate is closed pending calibration-only E4 freeze and separate authorization. [Protocol/results](docs/phase_reports/E1_E3_COMPARISON_PROTOCOL.md) · [Commands](docs/reproducibility/E1_E3_STAGE_E.md).

**Accuracy Improvement Stage D complete:** E3 Faster R-CNN finished 20/20 epochs (exit 0); epoch 13 selected. Independent **calibration500-only** evaluation: AP50 **0.563561**, AP50:95 **0.429070**, harmonic aggregate F1 **0.530884**; exact agreement with epoch 13. MPS batch-one median/p95 end-to-end **112.90/122.45 ms**, **8.75 still images/s**. These Stage D results must not be compared directly with historical YOLO metrics below; the matched calibration comparison is now available in Stage E above. Reserved1500 remains unused under the new protocol; no reserved E1/E3 comparison or fusion has begun.
